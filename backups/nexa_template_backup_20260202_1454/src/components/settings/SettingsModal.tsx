...
export function SettingsModal({ isOpen, onClose }: SettingsModalProps) {
    ...
    const [generalSubTab, setGeneralSubTab] = useState<'main' | 'voice'>('main'); // Sub-navigation for General tab
                ...
                <div className="flex flex-1 flex-col bg-white dark:bg-[#0f1117]">
                    ...
                    <div className="flex-1 overflow-y-auto px-12 pb-12">
                        ...
                        <div className="mb-8 flex items-center gap-2">
                            {generalSubTab === 'voice' && activeTab === 'general' && (
                                <button
                                    onClick={() => setGeneralSubTab('main')}
                            ...
                            <h3 className="text-2xl font-bold capitalize text-gray-900 dark:text-white">
                                {generalSubTab === 'voice' && activeTab === 'general' ? 'Voice' : tabs.find(t => t.id === activeTab)?.label}
                            </h3>
                        </div>
                            ...
                            <div className="max-w-2xl">
                                {generalSubTab === 'main' ? (
                                    <div className="space-y-8">
                                        ...
                                        {/* Voice Row */}
                                        <div
                                            onClick={() => setGeneralSubTab('voice')}
