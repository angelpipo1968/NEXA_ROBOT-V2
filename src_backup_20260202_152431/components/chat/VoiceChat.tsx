            ...
            <header className="p-4 border-b border-gray-800">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-bold">
                        <span className="text-blue-400">Nexa</span> Voice Chat
                    </h1>
                        ...
                        {messages.map(message => (
                            <div
                                ...
                                className={`mb-4 p-4 rounded-lg ${message.role === 'user'
                                    ? 'bg-blue-900/20 ml-auto max-w-[80%]'
                    ...
                    <div className="mt-4">
                        <div className="relative">
                            <textarea
                                ...
                                className="w-full p-4 pr-24 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 resize-none text-white"
                                rows={3}
                            />
