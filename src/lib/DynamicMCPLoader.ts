...
Responde ÚNICAMENTE con un JSON Array de strings exactos seleccionando de esta lista: ["search_web", "list_dir", "read_file", "write_file", "save_knowledge", "index_codebase", "codebase_search", "generate_image", "run_script"].
Consulta del usuario: "${userQuery}"`;
        ...
        const selectedTools = functionDeclarations.filter(t => activeToolNames.includes(t.name));
