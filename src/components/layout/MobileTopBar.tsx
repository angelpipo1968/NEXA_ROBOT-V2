...
export const MobileTopBar: React.FC<MobileTopBarProps> = ({ onPlusClick, isGuest }) => {
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-[calc(3.5rem+env(safe-area-inset-top))] pt-[env(safe-area-inset-top)] bg-white dark:bg-[#0a0a0f] border-b border-gray-100 dark:border-white/5 z-40 md:hidden flex items-center justify-between px-4 transition-colors gap-2">
