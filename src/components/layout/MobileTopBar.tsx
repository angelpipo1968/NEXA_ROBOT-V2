...
export const MobileTopBar: React.FC<MobileTopBarProps> = ({ onPlusClick, isGuest }) => {
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-14 bg-white dark:bg-[#0a0a0f] border-b border-gray-100 dark:border-white/5 z-40 md:hidden flex items-center justify-between px-4 transition-colors">
            <div className="flex items-center gap-2">
                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10">
                    <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">Qwen3-Max</span>
